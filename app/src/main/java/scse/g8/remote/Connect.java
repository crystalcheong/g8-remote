        ...
        lvPairedDevices.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        if (ActivityCompat.checkSelfPermission(Connect.this, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
        ...
        bluetoothConnect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                /*    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    intent1.setAction("scse.g8.remote.btConnectionStatus");
